...
interface Scene10InvestigationDrawerProps {
  transaction: TransactionEvaluation;
  onClose: () => void;
}

export const Scene10InvestigationDrawer: React.FC<Scene10InvestigationDrawerProps> = ({
  transaction,
  onClose,
}) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden select-none">
      ...
      <div className="fixed inset-y-0 right-0 max-w-2xl w-full flex pl-6">
        <div className="w-full h-full bg-[#090c12] shadow-2xl flex flex-col border-l border-white/[0.08] animate-slide-in-right">
          
          {/* Drawer Header */}
          <div className="px-8 py-6 border-b border-white/[0.06] bg-[#0c1018] flex-shrink-0 flex items-start justify-between">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="text-[10px] font-mono font-bold text-slate-400 uppercase tracking-widest bg-slate-950 px-2 py-0.5 rounded border border-white/[0.08]">
              ...
              <div className="text-xs text-slate-400 mt-1 font-mono">
                Classified Root Cause: <span className="text-slate-200 font-bold">{formatLabel(transaction.root_cause)}</span>
              </div>
            </div>
          ...
          {/* Drawer Sequential Vertical Audit Trace */}
          <div className="flex-1 overflow-y-auto p-8 space-y-6">
            ...
            <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/[0.06] relative">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs font-mono mt-3">
                ...
                <div className="p-3 rounded-xl bg-slate-950/80 border border-white/[0.04]">
                  <span className="text-[10px] text-slate-500 block">FAILURE REASON</span>
            ...
            <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[10px] font-mono text-slate-500">Standard Rule v1.4</span>
              </div>
            ...
            {/* 03 AI Proposed Action */}
            <div className="p-5 rounded-2xl bg-gradient-to-br from-indigo-950/30 to-slate-950/80 border border-indigo-500/30">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
